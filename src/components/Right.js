...
export default function Right() {
  ...
  <img class="Logo1" src={logo} style={{size:'100px x 10px'}}alt="logo" />
    ...
    <button type="button" className="baseButton">Sıfırlama Maili Gönder</button>
    </div>
      <div className="footer" style={{ marginTop: '45px', marginRight: '30px</div>' }}>
        <span className="Giris-yapa-don">Giriş Yap'a Geri Dön</span>
        <hr className="hr" style={{ backgroundColor:'#f89f23'}}/>
      </div>

      <div className="footer" style={{marginTop:'90px',marginRight:'50px'}}>
        <span className="Aramza-katlmak-ister-misin-Kayt-Ol">
          Aramıza katılmak ister misin?{' '}
        </span>
        <span  className="kayit-ol" id="signUp">
